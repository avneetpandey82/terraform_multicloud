...
# The "description" parameter explains that the AMI ID corresponds to Ubuntu 18.04 in the selected region.
# The "default" parameter provides a pre-configured AMI ID for Ubuntu 18.04 in the "us-east-1" region.
variable "ami_id" {
    description = "AMI ID for Ubuntu 18.04 in the selected region"
    default     = "ami-0b8aeb1889f1a812a" # Ubuntu 18.04 in us-east-1
}
